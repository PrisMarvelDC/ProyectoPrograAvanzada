...
namespace ProyectoPAW.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(100, ErrorMessage = "El nombre debe de tener máximo  100 caracteres")]
            public string Nombre { get; set; }

            [Required(ErrorMessage = "Este dato es requerido")]
            [StringLength(100, ErrorMessage = "El apellido debe de tener máximo  100 caracteres")]
            public string Apellidos { get; set; }

            [Required(ErrorMessage = "Este dato es requerido")]
            [StringLength(20, ErrorMessage = "La cedula debe de tener máximo  20 caracteres")]
            [Display(Name = "Cedula")]
            public string Cedula { get; set; }

            [Required(ErrorMessage = "Este dato es requerido")]
            [StringLength(15, ErrorMessage = "El teléfono debe de tener máximo  15 caracteres")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // Verificar si el rol seleccionado existe
